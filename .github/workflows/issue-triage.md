...
5. Write notes, ideas, nudges, resource links, debugging strategies and/or reproduction steps for the team to consider relevant to the issue. Look at the files in the repository to identify where the problem could be that is creating the issue.
...
8. Add an issue comment to the issue with your analysis:
   ...
   - Mention where in the code the problem could be resolved.
